<x-slot name="header">
    <div class="uppercase flex items-center space-x-4">
        <h2 class="text-sm font-semibold text-rosains dark:text-gray-200 leading-tight">
...
<form
    ...
    <div id="fase1" class="border p-3 rounded-lg border-doradoins">
        {{-- Fase 1 Alineacion --}}
        <div class="bg-white dark:bg-teal-600 overflow-hidden shadow-sm sm:rounded-lg p-2 text-rosains border-b-pink-500 border-b-2">
            Fase 1: Alineación
        </div>
        {{-- Compromisos --}}
        <div class="mt-4">
    ...
    <div id="fase4" class="border p-3 rounded-lg border-doradoins">
        {{-- Meta Alcanzada --}}
        <div class="bg-white dark:bg-teal-600 overflow-hidden shadow-sm sm:rounded-lg p-2 text-rosains mt-3 border-b-pink-500 border-b-2">
            Meta Alcanzada <br />
