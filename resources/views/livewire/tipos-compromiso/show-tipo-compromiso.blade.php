<x-slot name="header">
    <div class="flex items-center space-x-4">
        <h2 class="text-xl font-semibold text-gray-800 dark:text-gray-200 leading-tight">
            {{ __('Mostrar tipo de compromiso') }}
        </h2>
    </div>
    <div class="mb-1 mt-2">
        <a href="{{ route('tipo-compromiso') }}"
...
<form wire:submit.prevent="editCompromise"
    ...
    {{-- Campo: Número tipo de compromiso --}}
    <div class="relative"> {{-- x-show y x-transition eliminados --}}
        <label for="compromiso_numero"
               class="block mb-1 text-sm font-medium text-gray-600 dark:text-gray-300 uppercase">Número tipo de compromiso</label>
    ...
    {{-- Campo: Nombre tipo de compromiso --}}
    <div class="relative"> {{-- x-show y x-transition eliminados --}}
        <label for="compromiso_nombre"
               class="block mb-1 text-sm font-medium text-gray-600 dark:text-gray-300 uppercase"> Nombre tipo de compromiso</label>
        <input id="compromiso_nombre" type="text"
               wire:model.defer="compromiso_nombre"
               placeholder="Nombre del tipo de compromiso"
               class="peer w-full pl-4 pr-10 py-3 rounded-xl border border-gray-300 dark:border-gray-600 bg-white/70 dark:bg-gray-800/60 backdrop-blur-md text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-sky-500 focus:outline-none transition duration-200 placeholder-gray-400 dark:placeholder-gray-500"/>
        <div class="absolute right-3 top-9">
        ...
        {{-- Campo: Descripción tipo de compromiso --}}
    <div class="relative"> {{-- x-show y x-transition eliminados --}}
        <label for="compromiso_nombre"
               class="block mb-1 text-sm font-medium text-gray-600 dark:text-gray-300 uppercase"> Descripción tipo de compromiso</label>
        <input id="compromiso_nombre" type="text"
               wire:model.defer="compromiso_nombre"
               placeholder="Descripción del tipo de compromiso"
               class="peer w-full pl-4 pr-10 py-3 rounded-xl border border-gray-300 dark:border-gray-600 bg-white/70 dark:bg-gray-800/60 backdrop-blur-md text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-sky-500 focus:outline-none transition duration-200 placeholder-gray-400 dark:placeholder-gray-500"/>
        <div class="absolute right-3 top-9">
            @error('compromiso_nombre')
            <svg class="w-5 h-5 text-sky-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
