...
<form wire:submit.prevent="editCompromise"
    ...
    {{-- Campo: Número de concepto --}}
    <div class="relative"> {{-- x-show y x-transition eliminados --}}
        <label for="ods_numero"
               class="block mb-1 text-sm font-medium text-gray-600 dark:text-gray-300 uppercase">Número de concepto</label>
        <input id="ods_numero" type="number" min="1"
               wire:model.defer="ods_numero"
               placeholder="Ej. 123"
    ...
    <div class="relative"> {{-- x-show y x-transition eliminados --}}
        <label for="ods_nombre"
               class="block mb-1 text-sm font-medium text-gray-600 dark:text-gray-300 uppercase"> Descripción del concepto</label>
        <input id="ods_nombre" type="text"
               wire:model.defer="ods_nombre"
...
<style>
    ...
    <div>
        <button type="submit"
            ...
            <span x-show="!loading">CREAR ODS</span>
        </button>
    </div>
